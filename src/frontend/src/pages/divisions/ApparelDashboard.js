...
const ApparelDashboard = () => {
  ...
  const [dashboardData, setDashboardData] = useState({
    ...
    productionSummary: { 
      shirts: { daily: 0, weekly: 0, monthly: 0 },
      jackets: { daily: 0, weekly: 0, monthly: 0 },
      accessories: { daily: 0, weekly: 0, monthly: 0 }
    }
  });
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        const mockData = {
          inventorySummary: { totalItems: 1050, lowStock: 35, outOfStock: 9 },
          manufacturingOrders: { total: 52, inProgress: 26, completed: 22, delayed: 4 },
          customerOrders: { total: 36, pending: 14, inProgress: 16, completed: 6 },
          incomingTransfers: { total: 16, pending: 5, received: 11 },
          productionSummary: { 
            shirts: { daily: 200, weekly: 1400, monthly: 6000 },
            jackets: { daily: 75, weekly: 525, monthly: 2250 },
            accessories: { daily: 120, weekly: 840, monthly: 3600 }
          }
        };
        ...
        <Grid item xs={12} md={6}>
          <Card>
            <CardHeader 
              ...
              avatar={<CheckroomIcon color="primary" />}
              action={
            ...
            <CardContent>
              <Grid container spacing={2}>
                <Grid item xs={12}>
                  <Typography variant="subtitle2" gutterBottom>Shirts</Typography>
                  <Grid container spacing={2}>
                    <Grid item xs={4}>
                      <Typography variant="h6" align="center">{dashboardData.productionSummary.shirts.daily}</Typography>
                      <Typography variant="body2" color="text.secondary" align="center">Daily</Typography>
                    </Grid>
                    <Grid item xs={4}>
                      <Typography variant="h6" align="center">{dashboardData.productionSummary.shirts.weekly}</Typography>
                      <Typography variant="body2" color="text.secondary" align="center">Weekly</Typography>
                    </Grid>
                    <Grid item xs={4}>
                      <Typography variant="h6" align="center">{dashboardData.productionSummary.shirts.monthly}</Typography>
                ...
                <Grid item xs={12} sx={{ mt: 1 }}>
                  <Typography variant="subtitle2" gutterBottom>Jackets</Typography>
                  <Grid container spacing={2}>
                    <Grid item xs={4}>
                      <Typography variant="h6" align="center">{dashboardData.productionSummary.jackets.daily}</Typography>
                      <Typography variant="body2" color="text.secondary" align="center">Daily</Typography>
                    </Grid>
                    <Grid item xs={4}>
                      <Typography variant="h6" align="center">{dashboardData.productionSummary.jackets.weekly}</Typography>
                      <Typography variant="body2" color="text.secondary" align="center">Weekly</Typography>
                    </Grid>
                    <Grid item xs={4}>
                      <Typography variant="h6" align="center">{dashboardData.productionSummary.jackets.monthly}</Typography>
                      <Typography variant="body2" color="text.secondary" align="center">Monthly</Typography>
                    </Grid>
                  </Grid>
                </Grid>
...
export default ApparelDashboard;
